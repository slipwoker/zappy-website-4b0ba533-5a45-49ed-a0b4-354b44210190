document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        } else if (field.minLength && field.minLength > 0 && value.length < field.minLength) {
  ...
  function showFieldError(field, message) {
    ...
    if (!errorEl) {
      ...
      errorEl.id = 'error-' + (field.name || field.id || Math.random().toString(36).slice(2));
  ...
  function clearFormErrors(form) {
    ...
    const formMsg = form.querySelector('.form-success-message, .form-submit-error');
  ...
  const OBSERVED_SELECTOR = '.fade-in, .slide-up, .slide-in, [data-animate]';
  ...
  function initScrollAnimations() {
    ...
    if ('IntersectionObserver' in window) {
      ...
      animatableElements.forEach(function (el) {
        el.classList.add('animate-ready', ANIMATION_CLASS);
      });
    }
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רונן קלר וויליאמס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '4b0ba533-5a45-49ed-a0b4-354b44210190',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '4b0ba533-5a45-49ed-a0b4-354b44210190';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 0532236622 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4b0ba533-5a45-49ed-a0b4-354b44210190';
